...
# AlpineLinux has multiple versions of lua (5.1...5.4) in their
...
MOUNTFLAGS := \
	...
	# -v $(CURDIR)/luarocks:/home/alpine/.luarocks \
...
OTHERFLAGS := \
	...
	-e PUID=$(PUID) \
	# \
	# -e S6_NEEDED_PACKAGES="lua$(LUAMAJMIN)-dev build-base" \
	# -e S6_LUA_PACKAGES="luasocket 3.1.0,luajson 1.3.3" \
	# -e S6_LUA_USER_PACKAGES="luasocket 3.1.0,luajson 1.3.3" \
	# -e USERROCKSDIR=/home/alpine/.luarocks \
	# -e TZ=Asia/Kolkata \
	#
